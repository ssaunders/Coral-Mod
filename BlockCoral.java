...
//			world.destroyBlock(x, y, z, false);
	...
	// // CONSTRUCTOR // //
	public BlockCoral(int id,  CORAL_TYPE type, int maxHealth, int startHealth, int splitPoint, int expansionCost, int growthFactor, int livingCost, int photoFactor) {
